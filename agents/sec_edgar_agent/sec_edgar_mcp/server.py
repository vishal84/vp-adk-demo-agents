...
from .tools import CompanyTools, FilingsTools, FinancialTools, InsiderTools
...
def main():
    ...
    parser.add_argument("--port", type=int, default=int(os.environ.get("PORT", 8080)), help="Port to bind to (default: PORT env var or 8080)")
